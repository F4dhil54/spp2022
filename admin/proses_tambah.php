...
if($_POST){
    ...
    var_dump($level);
    include "koneksi.php";
    $his=mysqli_query($conn, "select username from petugas");
    ...
    if(empty($nama_petugas)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"INSERT INTO `petugas`(`id_petugas`, `username`, `password`, `nama_petugas`, `level`) VALUES ('NULL','$username','.".md5($password).".','$nama_petugas','$level')") or die(mysqli_error($conn));
        if($insert){
