    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="upload.php">Upload Transaksi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="historipembayaran.php">Histori Transaksi</a>
                </li>
                <li class="nav-item">
